...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen flex flex-col py-16 px-12 max-w-7xl mx-auto overflow-hidden bg-gray-50">
      <div className="font-bold text-5xl mb-6">
        Your Files, <br />
        <span className="text-[#4A80A6]">Neatly Organized.</span>
      </div>
      <div className="text-xl w-96 mb-12">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mb-6">
                  We support both individual files and entire folders
                </p>
